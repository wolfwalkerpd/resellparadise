  ...
  return (
    <section className="bg-[#434343] h-full p-7 text-white">
      <div className=" flex">
        ...
        <h2 className=" text-[40px] mt-3 pl-3">Add product</h2>
        <div className="">
        ...
        <form target="_blank">
          <div className="ml-10 relative">
            ...
            <input
              ...
              type="text"
              className=" border-b border-b-[#979797] text-[#979797]  bg-transparent my-3 outline-none block"
              placeholder="name"
            />
            <input
              type="text"
              className=" border-b border-b-[#979797] text-[#979797] bg-transparent inline my-4 outline-none "
              placeholder="price"
            />
            <label className=" absolute left-[250px] mt-3 text-[#979797]">USD$</label>
            <input
              type="submit"
              value="add"
              className=" bg-[#E9EC67] text-black mt-10 ml-52x px-6 rounded-lg py-2 block"
            />
          </div>
        </form>
      </div>
      <div className="md:flex 2sm:block mt-20 gap-10 md:ml-20 lg:ml-32">
        <div className="">
          ...
          <div className="bg-white w-[469px] h-60 relative p-10 flex rounded-md">
            <div className="bg-[#D9D9D9] w-32 h-[116px] mt-5 top-1/2 bottom-1/2">
              <img src={img} />
            </div>
        ...
        <div className=" w-[240px] h-[240px]">
          ...
          <div className="bg-white relative px-14 py-7 rounded-md">
            <div className="bg-[#D9D9D9] w-32 h-[116px] top-1/2 bottom-1/2">
              <img src={img} />
            </div>
